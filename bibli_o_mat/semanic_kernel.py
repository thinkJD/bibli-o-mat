...
class SemanticKernel:
    def __init__(self, api_key:str, org_id:str):
        ...
        self.kernel.config.add_text_backend("dv", OpenAITextCompletion("text-davinci-003", api_key, org_id))
        ...
        {{$input}}
        """
        self.book_list_short_story = self.kernel.create_semantic_function(book_list_short_story_prompt, max_tokens=2000, temperature=0.2, top_p=0.5)
